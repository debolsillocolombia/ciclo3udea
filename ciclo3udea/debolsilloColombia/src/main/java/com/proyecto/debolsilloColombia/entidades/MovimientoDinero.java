...
public MovimientoDinero(){}
    public
    MovimientoDinero ( String usuario , double consignar , double retirar , double saldoinit ) {
    ...
    public
    void setConsignar ( double consignar ) {
        this.consignar = consignar;
    }
    ...
    public
    void setRetirar ( double retirar ) {
        this.retirar = retirar;
    }
    ...
    public
    void setSaldoinit ( double saldoinit ) {
        this.saldoinit = saldoinit;
    }
}
